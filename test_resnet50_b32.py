...
class ResNet50_ViTB32_Hybrid(nn.Module):
    def __init__(self, num_classes=2):
        super(ResNet50_ViTB32_Hybrid, self).__init__()
    ...
    def forward(self, x):
        ...
        combined_features = torch.cat((resnet_features, vit_outputs), dim=1)
...
def federated_learning(num_rounds, local_epochs, patience=5):
    global_model = ResNet50_ViTB32_Hybrid(num_classes=2).to(device)
    ...
    for round in range(num_rounds):
        ...
        for client_loader in client_loaders:
            client_model = ResNet50_ViTB32_Hybrid(num_classes=2).to(device)
...
federated_learning(num_rounds=25, local_epochs=5, patience=4)