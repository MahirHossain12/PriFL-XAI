...
class ResNet18_ViTB16_Hybrid(nn.Module):
    def __init__(self, num_classes=2):
        super(ResNet18_ViTB16_Hybrid, self).__init__()
    ...
    def forward(self, x):
        ...
        vit_outputs = self.vit(pixel_values=x).logits  # Use pixel_values and .logits
